# -*- coding: utf-8 -*-
"""GRAPH:  YOLOv4-tiny-Darknet-Roboflow.ipynb
...
project = rf.workspace().project("dsp-xawgw")
...
import cv2
from google.colab.patches import cv2_ishow
#/test has images that we can test our detector on
test_images = 'www.jpg'
#import random
#img_path = "test/" + www.jpg;
...
!./darknet detector train data/obj.data cfg/yolov4-custom5.cfg custom-yolov4-tiny-detector_last.weights -map | tee results.log

from zipfile import ZipFile
import os

file_paths = []
for root, directories, files in os.walk('/content/darknet'):
 for filename in files:
    filepath = os.path.join(root, filename)
    file_paths.append (filepath)
           
with ZipFile('/content/DSP.zip','w') as zip:
